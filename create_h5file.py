...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  3 15:40:04 2020

@author: dilay
"""

# ACKNOWLEDGEMENTS:
# THIS WORK IS NOT MY OWN, rather I revised it to my particular use case!
# IT HAS BEEN TAKEN FROM THE 'create-a-hdf5-data-set-for-deep-learning repo
# on feiyuhuahuo's GitHub. Source below:
# https://github.com/feiyuhuahuo/create-a-hdf5-data-set-for-deep-learning
...
hdf5_path = 'data.hdf5'  # file path for the created .hdf5 file

data_path = 'dataset/*.jpg' # the original data path

# get all the image paths 
addrs = glob.glob(data_path)

# label the data as 0=cat, 1=dog
labels = [0 if 'N' in addr else 1 for addr in addrs] 

# shuffle data
if shuffle_data:
    c = list(map(list, zip(addrs, labels))) # use zip() to bind the images and labels together
    shuffle(c)
